...
const SectionRaiting = () => {
    ...
    useEffect(() => {
        const api = 'https://api.themoviedb.org/3/tv/top_rated?api_key='+process.env.REACT_APP_API_KEY_FILM+'&language=en-US&page=' + random;
